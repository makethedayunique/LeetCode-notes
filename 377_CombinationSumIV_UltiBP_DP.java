 ...
 * Output: 0
 * 
 * Solution: This is an ultimate Backpack problem. Every item can be used for multiple times. 
 * The order of the items matters.
 * So the external loop of should be the capacity and inner loop should be the items.
 * 
 */
class Solution {
